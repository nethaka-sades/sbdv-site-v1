          ...
          <div className="grid items-center gap-8 lg:grid-cols-2">
            ...
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <p className="mb-8 max-w-xl text-muted-foreground lg:text-lg font-plain">
                ...
                celebrated in our Dhamma School. The day
                is dedicated to teachers, who play a crucial role in shaping the
                future of students. The Prefects Guild of Sri Bodhiraja Dhamma
                School organizes a special event on Teachers' Day to honor the
                teachers of the school. The event includes speeches, cultural
